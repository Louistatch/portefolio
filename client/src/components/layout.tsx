    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <footer className="border-t border-border/50 py-12 mt-auto bg-muted/30">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-muted-foreground text-sm max-w-sm">
              Bridging the gap between agricultural finance, climate resilience, and artificial intelligence for a sustainable future.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/blog" className="hover:text-primary transition-colors">Scientific Blog</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-4">Connect</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/booking" className="hover:text-primary transition-colors">Schedule a Meeting</Link></li>
        ...
        <div className="max-w-7xl mx-auto px-6 mt-12 pt-8 border-t border-border/50 flex flex-col md:flex-row items-center justify-between text-xs text-muted-foreground">
          <p>© {new Date().getFullYear()} Louis Tatchida. All rights reserved.</p>
